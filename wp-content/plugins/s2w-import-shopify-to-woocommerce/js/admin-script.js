jQuery(document).ready(function ($) {
    ...
    $('.s2w-save-products-options').on('click', function (e) {
        ...
        data.action = 's2w_save_settings_product_options';
        $.ajax({
    ...
    function s2w_product_options_cancel() {
        ...
        $('#s2w-download_images').prop('checked', (settings.download_images == 1));
    ...
    $('.s2w-save-orders-options').on('click', function (e) {
        ...
        s2w_get_form_data();
        let data = Object.assign({}, settings);
        data.action = 's2w_save_settings_order_options';
        $.ajax({
            url: s2w_params_admin.url,
            type: 'POST',
            dataType: 'JSON',
    ...
    $('.s2w-save-coupons-options').on('click', function (e) {
        ...
        s2w_get_form_data();
        let data = Object.assign({}, settings);
        data.action = 's2w_save_settings_coupon_options';
        $.ajax({
            url: s2w_params_admin.url,
            type: 'POST',
            dataType: 'JSON',
    ...
    //     api_secret: '',
    //     download_images: 0,
    //     disable_background_process: 0,
    //     download_description_images: 0,
    //     keep_slug: 0,
    //     global_attributes: 0,
    //     product_status: '',
    //     variable_sku: '',
    ...
    //     customers_per_request: '',
    //     blogs_update_if_exist: [],
    //     customers_role: '',
    //     customers_with_purchases_only: 0,
    //     coupons_per_request: '',
    //     coupon_starts_at_min: '',
    //     coupon_starts_at_max: '',
    //     coupon_ends_at_min: '',
    //     coupon_ends_at_max: '',
    //     coupon_zero_times_used: 0,
    //     orders_per_request: '',
