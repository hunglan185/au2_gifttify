 ...
 */
namespace Barn2\Plugin\WC_Variation_Prices\Dependencies\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('Barn2\\Plugin\\WC_Variation_Prices\\Dependencies\\HHVM_VERSION')) {
