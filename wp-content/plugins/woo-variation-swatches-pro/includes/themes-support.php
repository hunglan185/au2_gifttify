...
// ==========================================================
// Impreza Add cart button issue
// ==========================================================

if ( ! function_exists( 'wvs_impreza_add_to_cart_markup_fix' ) ):
	function wvs_impreza_add_to_cart_markup_fix() {

		if ( function_exists( 'us_add_to_cart_text_replace' ) ) {
			add_filter(
...
add_action( 'init', 'wvs_impreza_add_to_cart_markup_fix', 20 );
